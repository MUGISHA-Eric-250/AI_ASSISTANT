...
    api_key="28aa20b9-0052-427f-9e3d-deadce217444"
)

mcp = MCPClient(
    base_url="https://mcp.circuitnotion.com/mcp"
)
...
        out = chat(user)
        print("AI:", out)GATSINZI   frank  [10:53 PM]
from openai import OpenAI
from cn_mcp import MCPClient
import json
import re
...
mcp = MCPClient(api_key="2b1df4a1-e473-4e66-9ccb-203caa396614")
